...
The resulting differentiation tree is presented. It reports the various TESs with the attractors of which they are composed and the differentiation process emerging from the reduction of intracellular noise, synthesised by the thresholds present in the direct arcs.
![Differentiation Tree](exampleTree.svg)
